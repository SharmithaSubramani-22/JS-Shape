...
function shapes() {
    ...
    for(let i=0;i<loop;i++){
        if(selectedShape==="Circle"){
            ...
            circle.setAttribute("style","height: 50px; width: 50px;background-color:mediumorchid; border-radius: 100%;"); 
            ...
            square.setAttribute("style","height: 50px; width: 50px;  background-color:lightblue;"); 
            let content=document.createTextNode(num);
            ...
            rect.className="out";
            rect.setAttribute("style","height: 50px; width: 75px;  background-color:lightpink;"); 
            let content=document.createTextNode(num);
